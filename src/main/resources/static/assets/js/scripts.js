                    ...
                    result.statistics.detailed.forEach(function(site){
                        ...
                        $blockSiteExample.find('.Statistics-description')
                            .html('<div class="Statistics-option"><strong>Status time:</strong> ' +
                                ...
                                ((site.tasks > 0) ? '</div><div class="Statistics-option"><strong>Tasks:</strong> ' + site.tasks : '') +
                                (site.error ? '</div><div class="Statistics-option Statistics-option_error"><strong>Error:</strong> ' + site.error : '') +
                                '</div>')
